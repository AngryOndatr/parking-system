...
docker-compose -f $composeFile -f $overlayFile --env-file $envFile build --parallel
...
docker-compose -f $composeFile -f $overlayFile --env-file $envFile up -d postgres redis prometheus grafana jaeger otel-collector pgadmin
